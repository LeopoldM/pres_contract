...
\begin{frame}{The set up}\label{FirstCont}
...
\begin{itemize}
    \item A set of firms offers a fixed menu of contracts: \boldrblue{a fixed-price (FP) and a dynamic-price (RTP) contract} \vfill
    \item Consumer chooses a contract: \boldrblue{commitment on price profile} \vfill
...
\item \boldrblue{Advantageous selection} can be realized with public funds/taxes: \vfill
    ...
    \begin{center}
    $W$(\textcolor{blue}{Dynamic} +  \textcolor{red}{Fixed-Price})  { \textbf{  < }} $W$( \textcolor{red}{Fixed-Price})
   \end{center}
...
\begin{frame}{Contributions}\label{FirstCont}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item We assume w.l.o.g. that $c_1 < c_2$ and $\mathbf{c}:= (c_1,c_2)$ 
    \end{itemize}
